...
export function createLayers({ mountain, clouds, plateau, heroEnd = 0.56, enterAt = null, cfg = LAYERS }) {   // enterAt: v4 — the plateau's rise on the intro video's clock instead of the scroll
