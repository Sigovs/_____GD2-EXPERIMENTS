...
export const WATER_LIFE = {
	...
	motes: { count: 480, size: [0.5, 2.6], alpha: [0.16, 0.66], rise: [4, 18], sway: 9, parallax: 18, scrollPush: 0.9 },   // Alex, 18 Sep: "побольше этого" — 90 → 240 → 480, a livelier drift
...
export function createWaterLife({ canvas, waterCanvas, textureUrl = 'assets/textures/caustics.png', cfg = WATER_LIFE }) {
	...
	function resize() {
		...
		dpr = 1;   // the life is soft: one pixel per CSS pixel everywhere
