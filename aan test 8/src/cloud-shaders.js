...
void main() {
	...
	alpha += smoothstep(0.2, 0.2 + uEdgeFeather, vUv.y) * (1.0 - smoothstep(0.7 - uEdgeFeather, 0.7, vUv.y))
		* smoothstep(0.2, 0.2 + uEdgeFeather, vUv.x) * (1.0 - smoothstep(0.9 - uEdgeFeather, 0.9, vUv.x));
