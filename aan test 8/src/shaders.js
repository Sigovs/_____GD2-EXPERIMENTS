...
uniform vec2 uFloorCut;         // test 8: world y band below which the cloud plates are gone (x = fully gone, y = untouched)
...
void main() {
	...
	alpha *= smoothstep(uFloorCut.x, uFloorCut.y, vWorldY);   // the water owns the bottom of the frame: the plates end above it
