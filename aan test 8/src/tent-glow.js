...
export const TENT_GLOW = {
	...
	breath: { period: 2.6, depth: 0.14 },      // slow swell of the whole stack
	tremble: { period: 0.72, depth: 0.07 },    // the quick shiver of a flame
	...
	parallax: 8,                               // px: the lean toward the cursor
	mouseEase: 2.0,
	sprite: 256,
};
