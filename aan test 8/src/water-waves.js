...
export const WATER_WAVES = {
	...
	refract: 0.5,               // uv units of bend at a slope of 1 — the strength of the lens
	highlight: 2.2,             // the crest's light (soft-limited in the shader)
	drop: { move: [0.35, 1.0], press: 2.0, radius: [0.016, 0.028], spacing: 22, minGap: 30, speedFull: 700 },   // move: [min, max] depth by cursor speed; radius in uv of the width; spacing: px and minGap: ms between drops
